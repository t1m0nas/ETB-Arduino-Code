...
/*!
 *  @brief  Configures the INA219 to measure up to 32V and 50A
 *          with a shunt resistor of 1.5 mΩ.
 */
void Adafruit_INA219::setCalibration_32V_2A() {
  // VBUS_MAX = 32V
  // VSHUNT_MAX = 0.075V (75mV) -> shunt voltage range
  // RSHUNT = 0.0015 (1.5 mΩ)
  ...
  // MinimumLSB = 50 / 32767 ≈ 0.001526A (1.526 mA per bit)
  // MaximumLSB = MaxExpected_I / 4096
  // MaximumLSB = 50 / 4096 ≈ 0.0122A (12.2 mA per bit)

  // 4. Choose an LSB between the min and max values
  // CurrentLSB = 0.002 (2 mA per bit)
  float currentLSB = 0.002; // 2 mA per bit

  // 5. Compute the calibration register
  // Cal = trunc(0.04096 / (CurrentLSB * RSHUNT))
  // Cal = trunc(0.04096 / (0.002 * 0.0015)) ≈ 13653
  uint16_t calibration_value = 13653;

  ina219_calValue = calibration_value;

  // 6. Calculate the power LSB
  // PowerLSB = 20 * CurrentLSB
  // PowerLSB = 20 * 0.002 = 0.04 (40 mW per bit)
  ina219_powerMultiplier_mW = 0.04; // Power LSB = 40 mW per bit

  // Set multipliers to convert raw current/power values
  ina219_currentDivider_mA = 0.002; // Current LSB = 2 mA per bit
